...
define( 'QMERCE_VERSION', '2.1.2' );
define( 'QMERCE_SDK_VERSION', 'latest' );
// For dev: define( 'QMERCE_SDK_VERSION', 'dev' );
define( 'QMERCE_INTERACTION_BASEURL', 'https://interaction.apester.com' );
define( 'QMERCE_EDITOR_BASEURL', 'https://app.apester.com' );
define( 'APESTER_EDITOR_BASEURL', 'https://app.apester.com' );
define( 'QMERCE_USER_SERVICE', 'https://users.apester.com' );
define( 'QMERCE_RENDERER_BASEURL', 'https://renderer.apester.com' );
define( 'QMERCE_STATIC_BASEURL', 'https://static.apester.com/js/sdk' );

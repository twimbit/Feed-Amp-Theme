...
<<<<<<< HEAD
        <a id="feed-button" class="nav_button" href="<?php echo home_url(); ?>" aria-label="feed button">
=======
        <a id="feed-button" class="nav_button" onclick="visitFeed()" href="#">
...
<<<<<<< HEAD
        <a id="explore-button" class="nav_button" href="<?php echo home_url(); ?>/explore" aria-label="explore button">
=======
        <a id="explore-button" class="nav_button" onclick="visitExplore()" href="#">
>>>>>>> 2f77e20c5969c5594cb305cd714854b94c50f0ba
            <svg>

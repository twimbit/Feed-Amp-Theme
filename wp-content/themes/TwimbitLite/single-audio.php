...
<body>
    ...
    <div class="row">
        <!--Main div    -->
        <div class="lg-col-8 md-col-12 sm-col-12 xs-col-12" style="margin-top: 0px;">
            <!-- 1st div divided into 66%size of the page-->

            <div class="feed-card">
                <!-- feature image main holder-->
                <div class="single-thumbnail">
                    ...
                    <div class="post-content">
                        <!-- post content on the image main div-->
                        ...
                        <p class="feed-content" style="margin-top:20px;  color:white;">
                            <!-- podcast description-->
                    ...
                    <a href="<?php echo $post_url; ?>">
                        ...
                        <div class="short-card">
                            ...
                            <div class="short-image" style=" ">
                                <!-- podcast image-->
                                <img style="border-radius: 10px !important;" class="short-image" src="<?php print $post_img; ?>" width="100px" height="100px" alt="" align="left">

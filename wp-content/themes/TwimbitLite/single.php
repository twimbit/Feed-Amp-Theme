...
<section class="featured-image" style="padding: 0px;background-image:url('<?php print the_post_thumbnail_url(); ?>');">
    <div class="single-thumbnail">
        ...
        <div class="featured-image-text xs-col-12 sm-col-8 md-col-7 lg-col-6">
            <h3 style="text-decoration: underline;color: #f5f5f5">Article title</h3>
            <h2><?php the_title(); ?></h2>
            <h6 style="color: #f5f5f5" class="mt2">Article date</h6>
            <h6 style="color: #f5f5f5">Article author</h6>
        </div>
        </div>

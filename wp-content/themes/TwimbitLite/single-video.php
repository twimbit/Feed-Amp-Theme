        ...
        <div class="right-side">
            ...
            <?php
		        ...
		        foreach (array_slice($get_post, 0,) as $val) {
			        ...
			        $video_category = get_the_category($val);
			?>
             <a href="<?php echo $video_url; ?>" style="text-decoration:none;">
                 <div class="short-card"> <!-- container of next video option -->
                     ...
                     <div class="details">    <!--video details container -->
                         <p class="detail1 ">   <!-- video heading -->
                             <?php echo $video_title; ?>
                         </p>
                         <div class="sub1">          <!-- video artist and category name -->

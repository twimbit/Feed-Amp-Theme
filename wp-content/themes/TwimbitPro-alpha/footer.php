...
<footer id="colophon" class="site-footer footer_amp tabs_bottom md-hide lg-hide" role="contentinfo">
    <div class="footer-content flex">
        <a id="feed-button" class="nav_button feed-selector-class" <?php if (!(is_home())) {
                                                                        ?> href="<?php echo home_url(); ?>" <?php } ?> on="tap:explore-tab-section.hide(),feed-tab-section.show()" aria-label="feed button">
            <svg>

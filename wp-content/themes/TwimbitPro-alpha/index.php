...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // console.log(h);
        if (h < 12) {
            document.querySelector('.nutshell-top').style.backgroundImage = "url(<?php echo content_url() . '/themes/TwimbitPro-alpha/src/morning.jpeg'; ?>)"
        } else if (h >= 12 && h < 17) {
            document.querySelector('.nutshell-top').style.backgroundImage = "url(<?php echo content_url() . '/themes/TwimbitPro-alpha/src/afternoon.jpg'; ?>)"
        } else if (h >= 17 && h < 19) {
            document.querySelector('.nutshell-top').style.backgroundImage = "url(<?php echo content_url() . '/themes/TwimbitPro-alpha/src/evening.jpeg'; ?>)"
        } else {
            document.querySelector('.nutshell-top').style.backgroundImage = "url(<?php echo content_url() . '/themes/TwimbitPro-alpha/src/night.jpeg'; ?>)"
        }

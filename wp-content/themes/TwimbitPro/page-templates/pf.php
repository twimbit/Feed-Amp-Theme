<?php function getAllData($post_type, $number=5) { $args=array( 'numberposts'=> $number,
...
<div class="count">
<?php if ($type=="post") { echo "Insight"; } else if ($type=="video") { echo "Video"; } else if ($type=="podcast") { echo "Podcast"; } else if ($type=="amp_story") { echo "Story"; } ?>
</div>
</div>
</div>
</div>
...
<?php } } function getAllExplores() { $trending=array( 'numberposts'=> 0,
'category' => get_category_by_slug('trending')->term_id,
'orderby' => 'date',
...
<?php foreach ($get_trending as $val) { $trending_img=get_the_post_thumbnail_url($val); $trending_url=get_the_permalink($val); $trending_title=get_the_title($val); $type=get_post_type($val); ?>
...
<div class="container cat-section" style="margin-bottom:2rem;padding-right:0;padding-left:0">
<div class="section-heading" style="margin:0 0 30px 0">
...
<?php foreach ($business_child as $val) { $post_img=get_field('featured_image', $val)['sizes']; ?>
...
<amp-carousel class="sub-cat" type="carousel" controls height="150">
<div class="sub-cat-inner-container">
<?php foreach ($careers_child as $val) { $post_img=get_field('featured_image', $val)['sizes']; ?>
...
<amp-carousel class="sub-cat" type="carousel" controls height="150">
<div class="sub-cat-inner-container">
<?php foreach ($companies_child as $val) { $post_img=get_field('featured_image', $val)['sizes']; ?>
...
<amp-carousel class="sub-cat" type="carousel" controls height="150">
<div class="sub-cat-inner-container">
<?php foreach ($technology_child as $val) { $post_img=get_field('featured_image', $val)['sizes']; ?>
...
<amp-carousel class="sub-cat" type="carousel" controls height="150">
<div class="sub-cat-inner-container">
<?php foreach ($events_child as $val) { $post_img=get_field('featured_image', $val)['sizes']; ?>
...
<amp-carousel class="sub-cat" type="carousel" controls height="150">
<div class="sub-cat-inner-container">
<?php foreach ($exclusive_child as $val) { $post_img=get_field('featured_image', $val)['sizes']; ?>
...
<amp-carousel class="sub-cat" type="carousel" controls height="150">
<div class="sub-cat-inner-container">
<?php foreach ($geography_child as $val) { $post_img=get_field('featured_image', $val)['sizes']; ?>
...
<amp-carousel class="sub-cat" type="carousel" controls height="150">
<div class="sub-cat-inner-container">
<?php foreach ($industry_child as $val) { $post_img=get_field('featured_image', $val)['sizes']; ?>

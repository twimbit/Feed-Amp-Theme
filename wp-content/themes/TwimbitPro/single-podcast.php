<?php get_header(); $post_args=array( 'numberposts'=> 0,
'category' => 0,
'orderby' => 'date',
...
?>
<style>.detail1{width:98%;font-size:12px;overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;text-transform:capitalize}@media(min-width:375px) and (max-width:425px){.detail1{font-size:13px}}@media(min-width:425px) and (max-width:520px){.detail1{font-size:14px}}@media(min-width:520px) and (max-width:640px){.detail1{font-size:15px}}@media(min-width:640px) and (max-width:726px){.detail1{font-size:11px}}@media(min-width:726px) and (max-width:767px){.detail1{font-size:10px}}@media(min-width:768px) and (max-width:1024px){.detail1{font-size:10px}}@media(min-width:640px){.right-side{margin:11px 15px;max-width:450px}.feed-card{margin:0 15px!important}.podcast>div{margin-top:15px}}@media(min-width:1024px){.feed-card{margin:0 15px 0 10%!important}.video-container{margin-left:10%}.video-description{margin-left:10%}.detail-video{margin-left:10%}}</style>
<div class="container-fluid">
<div class="row podcast" style="margin-right:0px;margin-left:0px">
<div class="lg-col-7 md-col-7 sm-col-7 xs-col-12 podcast-cover">
<div class="feed-card podcast-card">
<div class="single-thumbnail">
<amp-img layout="fill" src="<?php echo $post_img.".webp"; ?>"></amp-img>
...
<p class="video-title"><?php echo $post_title; ?></p>
<span>By <?php echo $author; ?></span>
...
<div style="margin-top:0;overflow:auto;word-break:break-word">
<?php echo $post->post_content; //contents saved in a variable
?>
</div>
</div>
</div>
...
<hr>
<?php $get_post=get_posts($post_args); foreach ($get_post as $val) { $post_img=get_the_post_thumbnail_url($val, 'thumbnail'); $post_url=get_permalink($val); $post_title=get_the_title($val); $author=get_the_author($val); $category_post=get_the_category($val); ?>
...
<style>.a{fill:rgba(0,0,0,0.55)}.b{fill:#fafafa;.c{filter:url(#a)}</style>
</defs>
<g>

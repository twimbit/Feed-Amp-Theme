...
<div id="post_area">
    <section class="featured-image" style="padding: 0px;background-image:url('<?php echo the_post_thumbnail_url() . '.webp'; ?>');">
                ...
                for ($i = 1; $i <= 2; $i++) {
                    ...
                    if (!empty($post)) { ?>
                        <div class="feed-card" style="height: 313px;width:49%">
                            <div class="single-thumbnail">
                                <amp-img layout="fill" src="<?php echo $exploreMore_img; ?>"></amp-img>
                                <div class="fade"></div>

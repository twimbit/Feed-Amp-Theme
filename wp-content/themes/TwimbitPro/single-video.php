...
?>
<style>.detail1{width:98%;font-size:11px;overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;text-transform:capitalize}@media(min-width:375px) and (max-width:425px){.detail1{font-size:11px}}@media(min-width:640px) and (max-width:726px){.detail1{font-size:11px}}@media(min-width:726px) and (max-width:767px){.detail1{font-size:10px}}@media(min-width:768px) and (max-width:1024px){.detail1{font-size:10px}}@media(min-width:640px){.right-side{margin:11px 15px;max-width:450px}.podcast>div{margin-top:15px}.video-container{margin:0 15px}}@media(min-width:1024px){.video-container{margin-left:10%}.video-description{margin-left:10%}.detail-video{margin-left:10%}}</style>
<div class="container-fluid">
<div class="row podcast" style="margin-right:0px;margin-left:0px">
<div class="lg-col-7 md-col-7 sm-col-7 xs-col-12">
...
<div class="lg-col-5 md-col-5 sm-col-5 xs-col-12">
...
<hr>
<?php $get_post=get_posts($post_args); foreach ($get_post as $val) { $video_img=get_the_post_thumbnail_url($val, 'thumbnail'); $video_url=get_permalink($val); $video_title=get_the_title($val); $artist=get_the_author($val); $video_category=get_the_category($val); ?>
